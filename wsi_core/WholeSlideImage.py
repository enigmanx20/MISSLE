...
#         self.name = ".".join(path.split("/")[-1].split('.')[:-1])
    ...
    def initXML(self, xml_path):
        ...
        self.contours_tissue  = [_createContour(coord_list) for coord_list in annotations]
        self.contours_tissue = sorted(self.contours_tissue, key=cv2.contourArea, reverse=True)
